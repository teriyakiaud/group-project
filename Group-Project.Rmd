...
Cluster analysis is commonly used in the biological and behavioral sciences, marketing, archaeology, and medical research.
...
=======
>>>>>>> fb88040c85756ab8ac98f44b968d4a59af2ced5e
...
[Punj, G., & Stewart, D. (1983). Cluster Analysis in Marketing Research: Review and Suggestions for Application. Journal of Marketing Research, 20(2), 134-148. doi:10.2307/3151680](http://www.jstor.org/stable/3151680?seq=1#page_scan_tab_contents)

[Pablo Tamayo, Donna Slonim, Jill Mesirov, Qing Zhu, Sutisak Kitareewan, Ethan Dmitrovsky, Eric S. Lander, and Todd R. Golub. Interpreting patterns of gene expression with self-organizing maps: Methods and application to hematopoietic differentiation. PNAS 1999 96 (6) 2907-2912; doi:10.1073/pnas.96.6.2907](http://www.pnas.org/content/96/6/2907.full.pdf)

[Johnson, A., & Johnson, A. (1975). K-Means and Temporal Variability in Kansas City Hopewell Ceramics. American Antiquity, 40(3), 283-295. doi:10.2307/279690](https://www.cambridge.org/core/journals/american-antiquity/article/div-classtitlespan-classitalickspan-means-and-temporal-variability-in-kansas-city-hopewell-ceramicsdiv/659CD81F64D6ED29DB73C185729177A5)
...
We will be using the wine dataset. This dataset contains the results of a chemical analysis of wines grown in a specific area of Italy. Three types of wine are represented in the 178 samples, with the results of 13 chemical analyses recorded for each sample. 
