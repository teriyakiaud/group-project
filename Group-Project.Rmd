...
This dataset contains 7 measurements for geometric properties of 210 kernels from 3 different varieties of wheat. This dataset is publicly available, though we will download it from our github repository as we have already converted it into a csv file.
...
```{r}
set.seed(1234)
fit.kmseed<-kmeans(ds, 3, nstart=25)
fit.kmseed$size
fit.kmseed$centers
```
