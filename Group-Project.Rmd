...
## Useful Skills You'll Learn Today
  Determining the number of clusters needed for a k-means cluster analysis 
  Clustering two different data sets
  Create a 2D representation of analysis
  Justify agreement of analysis using Rand index
